                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" id="title" type="text" name="title" v-model="data.title">
                            </div>
                            <div class="form-group">
                            ...
                            @if(!empty($jurisdiction))
                                <div class="form-group">
                                    <label for="jurisdiction_id">Jurisdiction it belongs to?</label>
                                    <select id="jurisdiction" v-model="data.jurisdiction_id" class="form-control"
